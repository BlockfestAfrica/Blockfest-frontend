-- The arithmetic audit's guards, in their own migration.
--
-- Written as additions to 0050 while it was unmerged; 0050 merged and
-- deployed with the value alignment alone, and an applied migration is
-- immutable, so the guards land here. Same body, new number.
