...
export function PasswordProtected({ children }: PasswordProtectedProps) {
  ...
  if (!isAuthenticated) {
    return (
      <div className="min-h-screen bg-ground flex items-center justify-center relative overflow-hidden">
        {/* Background Effects */}
        ...
        <div className="relative z-10 max-w-md w-full mx-4">
          <div className="bg-black/20 backdrop-blur-sm border border-white/20 rounded-xl p-8 shadow-2xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-md text-white placeholder-gray-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-blue-light focus-visible:border-transparent"
              ...
              <Button
                type="submit"
                className="w-full bg-brand-gold hover:bg-brand-gold-hover text-black font-semibold py-3 rounded-md transition-colors duration-200"
              >
                Access Insights
              </Button>
            </form>
