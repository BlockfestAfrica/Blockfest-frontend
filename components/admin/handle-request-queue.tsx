...
export function HandleRequestQueue({ requests }: { requests: RequestRow[] }) {
  ...
  return (
    <JobCard
      ...
      state="now"
      status={<Pill tone="bad">{requests.length} waiting</Pill>}
      ...
      <ul className="flex flex-col gap-4">
        {requests.map((request) => (
          ...
          >
            ...
            <blockquote className="mt-2 max-w-prose border-l-2 border-white/15 pl-3 text-sm leading-relaxed text-white/75">
              {request.reason}
            </blockquote>
            ...
            {rejecting === request.id ? (
              <div className="mt-3 flex flex-col gap-2">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="inline-flex min-h-11 cursor-pointer items-center rounded-full border border-red-400/40 px-5 text-sm font-semibold text-red-300 transition-colors hover:bg-red-400/15 disabled:opacity-60"
                  >
                  ...
                  <button
                    ...
                    className="inline-flex min-h-11 cursor-pointer items-center rounded-full px-4 text-sm font-semibold text-white/70 transition-colors hover:text-white"
                  >
                    Cancel
                  </button>
                </div>
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                <button
                  ...
                  className="inline-flex min-h-11 cursor-pointer items-center rounded-full bg-green-400/15 px-5 text-sm font-semibold text-green-300 transition-colors hover:bg-green-400/25 disabled:opacity-60"
                >
                  Approve the change
                </button>
                <button
                  ...
                  className="inline-flex min-h-11 cursor-pointer items-center rounded-full border border-white/20 px-5 text-sm font-semibold text-white transition-colors hover:bg-white/10 disabled:opacity-60"
                >
                  Reject
                </button>
              </div>
