...
export function SponsorshipSection() {
  ...
  const contactEmail =
    process.env.NEXT_PUBLIC_CONTACT_EMAIL || "partnerships@blockfestafrica.com";

  return (
    <section
      className="py-12 lg:py-16 bg-gradient-to-b from-[#031940] to-black relative overflow-hidden"
      id="sponsorship"
    >
      <div className="relative z-10 max-w-3xl mx-auto px-4 lg:px-8">
        ...
        <div className="text-center mb-8 lg:mb-10">
          ...
          <h2 className="text-3xl lg:text-5xl font-bold text-white mb-4 fade-in-on-scroll">
            Become a <span className="text-[#F2CB45]">Sponsor</span>
          </h2>
          <p className="text-white/70 text-base lg:text-lg max-w-3xl mx-auto fade-in-on-scroll">
            ...
            <span className="font-semibold text-[#F2CB45]">200 million+</span>{" "}
        ...
        {/* Contact CTA */}
        <div className="bg-gradient-to-br from-[#1B64E4] to-[#0D3B8C] rounded-2xl lg:rounded-3xl p-6 lg:p-10 text-center scale-in border border-white/10">
          ...
          <div className="flex flex-col gap-4 justify-center items-center">
            <Link
              ...
              className="inline-flex items-center gap-2 bg-[#F2CB45] text-black px-5 py-3 rounded-full font-semibold hover:bg-[#e8bc3d] transition-colors text-sm sm:text-base max-w-full"
            >
